...
<div class="scoreBoard">
    ...
    -->
        <div class="overallScore">
            ...
            <scoreBox class="inList" v-for="team in teams" :placement="team.position" :teamname="team.teamName" :points="team.teamPoints" :class="(($store.state.profile.teamName ?? 'none') == team.teamName) ? 'yourTeam' : ''"/>
        </div>
    <!-- </div> -->
