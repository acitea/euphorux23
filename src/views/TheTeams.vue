...
// https://www.instagram.com/smuxplorationcrew/
    ...
    data () {
        return {
            teams : {
                    ...
                    'xseed' : {desc: `XSEED is an outdoor adventure sports club providing students with a platform to venture into thrilling board-sports such as Cable Skiing, Longboarding, and Stand-Up Paddleboarding. <br><br>Over the years, we have built a community of outgoing and adventurous individuals who eagerly take part in our regular activities. In addition to our line-up of local regular activities, XSEED also organises overseas expeditions for SMU students to cultivate adventurousness and global exposure. Students will have opportunities to organise and try out new adventure sports which are unavailable in Singapore such as Alpine Sports, ATV Cross Country Riding & White Water Rafting. <br><br>You can expect to grow holistically within a community of like minded-individuals and hone your sporting skills with our activities! Join us as we Xplore frontiers and share Xciting adventures together!`,
                    links: {
                        tele: 'https://t.me/smuxseed',
                        insta: 'https://www.instagram.com/smuxxseed/'
                    }},
                }
        }
    },
